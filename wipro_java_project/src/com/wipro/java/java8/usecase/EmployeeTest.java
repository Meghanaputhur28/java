...
public class EmployeeTest {
    ...
    public void setUp() {
        ...
        service.addEmployee(new Employee(1, "Meghana", "IT", 350000, LocalDate.of(2020, 5, 10)));
        service.addEmployee(new Employee(2, "Kaushik", "Software", 345000, LocalDate.of(2019, 3, 15)));
        service.addEmployee(new Employee(3, "Vinay", "Masters", 360000, LocalDate.now()));
    }

    // Test adding a new employee
    @Test
    public void testAddEmployee() {
        Employee emp = new Employee(4, "Vishwa", "Teaching", 355000, LocalDate.of(2021, 8, 22));
    ...
    public void testAddDuplicateEmployee() {
        ...
        assertEquals(1, count); // There should only be one "Meghana"
    }
